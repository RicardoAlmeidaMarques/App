...
<div style="position:relative; float:Right;margin-top:-50px;margin-right:0px;"><input type='text' name='Nome' id='Nome'  maxlength="70" size="45" value="Introduza o nome do agente ou o seu código."  onFocus="this.value=''"/><input type="submit" name="pesquisa" value="Pesquisar" /></div>
</form>
</div>
<?php
