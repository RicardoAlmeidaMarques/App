...
<div style="margin-top:100px; min-height:100%; ">	
	...
	<?php if ((permissoes($_SESSION['tipo_agente'],'adicionar_tipos_ciclo')==1)) {?>
	<BUTTON TYPE="submit" onClick="parent.location='adicionar_ciclos.php'"><IMG SRC="/img/adicionar_tipo_ciclo.png" ALIGN="absmiddle" ><br><br>Adicionar Ciclo</BUTTON>
	<?php } else { ?>
	<BUTTON TYPE="submit" disabled><IMG SRC="/img/adicionar_tipo_ciclo_greyed.png" ALIGN="absmiddle" ><br><br>Adicionar Ciclo</BUTTON>
	<?php } ?>
	<?php if ((permissoes($_SESSION['tipo_agente'],'editar_tipos_ciclo')==1)) {?>
	<BUTTON TYPE="submit" onClick="parent.location='editar_ciclos.php'"><IMG SRC="/img/editar_tipo_ciclo.png" ALIGN="absmiddle" ><br><br>Editar Ciclos</BUTTON>
	<?php } else { ?>
	<BUTTON TYPE="submit" disabled><IMG SRC="/img/editar_tipo_ciclo_greyed.png" ALIGN="absmiddle" ><br><br>Editar Ciclos</BUTTON>
	<?php } ?>
